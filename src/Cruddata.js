                                    ...
                                    {empdata &&
                                        empdata.map(item => (
                                            <tr key={item.id}>
                                                ...
                                                <td>{item.email}</td>
                                                <td>{item.phone}</td>
                                                <td><a onClick={() => loadcontent(item.id)} className='btn btn-dark m-1 text-white'>Edit</a>
                                                    <a onClick={() => deletecontent(item.id)} className='btn btn-danger text-white'>Delete</a>
                                                </td>
                                            </tr>
                                        ))
                                    }
